...
class OpinionPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tableTitle: ['Self', 'Person', 'Team', 'Manager', 'Office', 'Suggestion'],
      tableData: [
        [this.props.opinion.self],
        [this.props.opinion.person],
        [this.props.opinion.team],
        [this.props.opinion.manager],
        [this.props.opinion.office],
